<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KayitOl.aspx.cs" Inherits="Proje1OkulKayit.KayitOl" %>
                ...
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li><a href="index.html">Bize Katılın</a></li>
                            <li>
                                ...
                                <ul>
                                    <li><a href="web/index.html" class="drop-text">Etkinlikler</a></li>
                                    <li><a href="web/index.html" class="drop-text">Ne Yapyoruz?</a></li>
                                    <li><a href="web/index.html" class="drop-text">Popüler Kurslar</a></li>
                                    <li><a href="web/index.html" class="drop-text">İstatistikler</a></li>
                                    <li><a href="web/index.html" class="drop-text">Galerimiz</a></li>
                                </ul>
                            </li>
    ...
    <div class="inner-banner-w3ls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body mt-md-2 mt-5">
                <h3 class="title-w3 mb-5 text-center text-wh font-weight-bold">Şimdi Kayıt Ol</h3>
                <form action="#" method="post" runat="server">
                    <div class="form-group">
                        <label class="col-form-label">Kullanıcı Adı</label>
                        <input type="text" class="form-control" placeholder="Kullanıcı Adınız..." name="Name" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" placeholder="Sehir..." name="Password" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <strong>
                    <asp:Button ID="Button1" runat="server" Text="Kayıt Ol" CssClass="btn btn-warning" />
                    </strong>
                </form>
            </div>
            <!-- //register -->
