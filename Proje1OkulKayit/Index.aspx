<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Proje1OkulKayit.Index" %>
    ...
    <header>
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-2 px-sm-2 px-1">
                <!-- logo -->
                <div id="logo">
                    <h1><a href="web/index.html">My School</a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            <li><a href="web/index.html">Ana Sayfa</a></li>
                            <li><a href="#about">Hakkımızda</a></li>
                            <li><a href="#join">Şimdi Katıl</a></li>
                            <li>
                                <!-- First Tier Drop Down -->
                                <label for="drop-2" class="toggle toogle-2">Sayfalar <span class="fa fa-angle-down"
                                        aria-hidden="true"></span>
                                </label>
                                <a href="#">Sayfalar <span class="fa fa-angle-down" aria-hidden="true"></span></a>
                                <input type="checkbox" id="drop-2" />
                                <ul>
                                    <li><a href="#events" class="drop-text">Duyurular</a></li>
                                    <li><a href="#what" class="drop-text">Ne Yapıyoruz?</a></li>
                                    <li><a href="#courses" class="drop-text">Popüler Kurslar</a></li>
                                    <li><a href="#stats" class="drop-text">İstatistikler</a></li>
                                    <li><a href="#gallery" class="drop-text">Galeri</a></li>
                                </ul>
                            </li>
                            <li><a href="#contact">İletişim</a></li>
                            <li><a href="web/login.html">Giriş Yap</a></li>
                            <li><a href="web/register.html">Kayıt Ol</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- //nav -->
    ...
    <div class="main-w3pvt mian-content-wthree text-center" id="home">
        <div class="container">
            <div class="style-banner mx-auto">
                <h3 class="text-wh font-weight-bold">Hoş Geldiniz <span>My School</span> <br>En İyi Eğitim İçin</h3>
                <p class="mt-3 text-li" id="join">My School'a Şimdi Katıl</p>
                <!-- form -->
                <div class="home-form-w3ls mt-5">
                    <form action="#" method="post">
                        ...
                        <button type="submit" class="btn_apt btn">Gönder</button>
                    </form>
                </div>
                <!-- //form -->
            </div>
